...
CORS(app, origins=["https://feelify.netlify.app", "https://the-repo.onrender.com"], supports_credentials=True)
...
def add_cors_headers(response):
    ...
    if origin in ["https://feelify.netlify.app", "https://the-repo.onrender.com"]:
